...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item{Obfuscated control flow (compilers can make all kinds of optimizing decisiions)}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
          ...
          \begin{itemize}
            \item{\textbf{Web: }Set breakpoints in chrome, look at the argument values instead of staring at 'a', 'b', and 'c'.}
...
\begin{frame}[fragile]
    ...
    \framesubtitle{... when everything is just a sea of bytes}
    \begin{itemize}
    ...
    \begin{bytefield}[bitwidth = 1.5em, leftcurly = .]{16}
        ...
        \end{leftwordgroup}\\[1ex]
        \begin{leftwordgroup}{}
		      \bitbox{12}{string: "Go Bucks", null-terminated} & \bitbox{4}{\small{Addr (0x3E8)}\\ \tiny{(Little endian)}}
        \end{leftwordgroup}\\[1ex]
    \end{bytefield}
    \begin{itemize}
